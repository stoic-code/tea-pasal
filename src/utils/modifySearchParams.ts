...
export const createSearchParms = (obj: { [key: string]: string | number | null | undefined }) => {
...
export const appendSearchParams = (base: string, obj: { [key: string]: string | number | null | undefined }) => {
    let output = base + '?'
...
// console.log(appendSearchParams('', { cid: 1 }))
