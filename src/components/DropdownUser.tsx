...
const DropdownUser = () => {
    const user = useSelector((store: any) => store.user.value.data)
        ...
        <div className='relative'>
            ...
            >
                <span className='hidden text-right lg:block'>
                    <span className='block text-sm font-medium text-black dark:text-white'>{/* {user.role} */}</span>
                    <span className='block text-sm font-medium text-black dark:text-white'>{/* {user.email} */}</span>
                    <span className='block text-xs'>{getFullName(user)}</span>
                </span>
